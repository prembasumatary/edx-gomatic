...
class TestDictMerge(unittest.TestCase):
    ...
    @data(({'key1': 'value1', 'key10': 'value1', 'key11': 'value2', 'key12': 'value3', 'key2': 'value2','key3': 'value3'},
            ["edxpipelines/tests/files/variables1.yml", "edxpipelines/tests/files/variables2.yml"],
            {'key1': "value1"},
            {'key2': "value2"}),
          ({'key1': 'value1', 'key10': 'value1', 'key11': 'value2', 'key12': 'value3', 'key2': 'value2', 'key3': 'value3', 'key4': {'nested_key1': {'nested_key2': 'nested_value2', 'nested_key3': 'nested_value3', 'nested_key4': 'nested_value4', 'nested_key5': 'nested_value5'}}},
           ["edxpipelines/tests/files/nested_variables1.yml", "edxpipelines/tests/files/variables2.yml"],
