...
def install_pipeline(save_config_locally, dry_run, variable_files, cmd_line_vars):
    ...
    clear_stage_caches_stage.set_has_manual_approval()
    ...
    stage_tag_name_artifact_params = {
        ...
        'src': FetchArtifactFile('test_tag_name.txt'),
        'dest': 'target'
    }
    ...
    tasks.generate_drupal_deploy(rollback_job, 'test', 'test_tag_name.txt')
